...
MATE_SETTINGS_PLUGIN_REGISTER_WITH_PRIVATE(MsdBackgroundPlugin,
                                           msd_background_plugin)

static void msd_background_plugin_init(MsdBackgroundPlugin* plugin) {
...
static void msd_background_plugin_finalize(GObject* object) {
...
static void impl_activate(MateSettingsPlugin* plugin) {
  ...
  error = NULL;
  res = msd_background_manager_start(
      MSD_BACKGROUND_PLUGIN(plugin)->priv->manager, &error);
...
static void msd_background_plugin_class_init(MsdBackgroundPluginClass* klass) {
...
static void msd_background_plugin_class_finalize(
    MsdBackgroundPluginClass* klass) {}

...
#define MSD_OSD_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), MSD_TYPE_OSD_WINDOW, MsdOsdWindow))
#define MSD_OSD_WINDOW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), MSD_TYPE_OSD_WINDOW, MsdOsdWindowClass))
#define MSD_IS_OSD_WINDOW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), MSD_TYPE_OSD_WINDOW))
#define MSD_IS_OSD_WINDOW_CLASS(klass) \
  (G_TYPE_INSTANCE_GET_CLASS((klass), MSD_TYPE_OSD_WINDOW))
#define MSD_OSD_WINDOW_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), MSD_TYPE_OSD_WINDOW, MsdOsdWindowClass))

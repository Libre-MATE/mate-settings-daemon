...
static void msd_dummy_manager_set_property(GObject *object, guint prop_id,
                                           const GValue *value,
                                           GParamSpec *pspec) {
  switch (prop_id) {
    default:
...
static void msd_dummy_manager_get_property(GObject *object, guint prop_id,
...
static GObject *msd_dummy_manager_constructor(
    GType type, guint n_construct_properties,
    GObjectConstructParam *construct_properties) {
  MsdDummyManager *dummy_manager;

  dummy_manager = MSD_DUMMY_MANAGER(
      G_OBJECT_CLASS(msd_dummy_manager_parent_class)
          ->constructor(type, n_construct_properties, construct_properties));

  return G_OBJECT(dummy_manager);
}

static void msd_dummy_manager_dispose(GObject *object) {
...
static void msd_dummy_manager_init(MsdDummyManager *manager) {

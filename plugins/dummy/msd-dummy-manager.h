...
#define MSD_DUMMY_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MSD_TYPE_DUMMY_MANAGER, MsdDummyManager))
#define MSD_DUMMY_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), MSD_TYPE_DUMMY_MANAGER, MsdDummyManagerClass))
#define MSD_IS_DUMMY_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), MSD_TYPE_DUMMY_MANAGER))
#define MSD_IS_DUMMY_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), MSD_TYPE_DUMMY_MANAGER))
#define MSD_DUMMY_MANAGER_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), MSD_TYPE_DUMMY_MANAGER, MsdDummyManagerClass))

...
#define MSD_MOUSE_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MSD_TYPE_MOUSE_MANAGER, MsdMouseManager))
#define MSD_MOUSE_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), MSD_TYPE_MOUSE_MANAGER, MsdMouseManagerClass))
#define MSD_IS_MOUSE_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), MSD_TYPE_MOUSE_MANAGER))
#define MSD_IS_MOUSE_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), MSD_TYPE_MOUSE_MANAGER))
#define MSD_MOUSE_MANAGER_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), MSD_TYPE_MOUSE_MANAGER, MsdMouseManagerClass))

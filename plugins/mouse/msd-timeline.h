...
#define MSD_TIMELINE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), MSD_TYPE_TIMELINE, MsdTimeline))
#define MSD_TIMELINE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), MSD_TYPE_TIMELINE, MsdTimelineClass))
#define MSD_IS_TIMELINE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), MSD_TYPE_TIMELINE))
#define MSD_IS_TIMELINE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), MSD_TYPE_TIMELINE))
#define MSD_TIMELINE_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), MSD_TYPE_TIMELINE, MsdTimelineClass))
...
struct MsdTimelineClass {
  ...
  void (*frame)(MsdTimeline *timeline, gdouble progress);

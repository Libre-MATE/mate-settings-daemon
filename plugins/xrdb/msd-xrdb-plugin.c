...
static void msd_xrdb_plugin_init(MsdXrdbPlugin *plugin) {
...
static void msd_xrdb_plugin_finalize(GObject *object) {
...
static void msd_xrdb_plugin_class_init(MsdXrdbPluginClass *klass) {
...
static void msd_xrdb_plugin_class_finalize(MsdXrdbPluginClass *klass) {}

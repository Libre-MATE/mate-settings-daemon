...
#define MSD_SMARTCARD_MANAGER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), MSD_TYPE_SMARTCARD_MANAGER, \
                              MsdSmartcardManager))
#define MSD_SMARTCARD_MANAGER_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), MSD_TYPE_SMARTCARD_MANAGER, \
                           MsdSmartcardManagerClass))
#define MSD_IS_SMARTCARD_MANAGER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), SC_TYPE_SMARTCARD_MANAGER))
#define MSD_IS_SMARTCARD_MANAGER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), SC_TYPE_SMARTCARD_MANAGER))
#define MSD_SMARTCARD_MANAGER_GET_CLASS(obj)                    \
...
struct _MsdSmartcardManagerClass {
  ...
  /* Signals */
  void (*smartcard_inserted)(MsdSmartcardManager *manager, MsdSmartcard *token);
  void (*smartcard_removed)(MsdSmartcardManager *manager, MsdSmartcard *token);
  void (*error)(MsdSmartcardManager *manager, GError *error);
};

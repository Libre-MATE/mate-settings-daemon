...
#define MSD_SMARTCARD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), MSD_TYPE_SMARTCARD, MsdSmartcardClass))
#define MSD_IS_SMARTCARD(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), MSD_TYPE_SMARTCARD))
#define MSD_IS_SMARTCARD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), MSD_TYPE_SMARTCARD))

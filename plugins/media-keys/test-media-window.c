...
static gboolean update_state(GtkWidget *window) {
  static int count = 0;
  ...
  switch (count) {
    case 1:
      msd_media_keys_window_set_volume_level(MSD_MEDIA_KEYS_WINDOW(window), 50);
...
static void test_window(void) {
  ...
  msd_media_keys_window_set_volume_level(MSD_MEDIA_KEYS_WINDOW(window), 0);
  msd_media_keys_window_set_action(MSD_MEDIA_KEYS_WINDOW(window),
                                   MSD_MEDIA_KEYS_WINDOW_ACTION_VOLUME);

...
#define MSD_MEDIA_KEYS_MANAGER(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MSD_TYPE_MEDIA_KEYS_MANAGER, \
                              MsdMediaKeysManager))
#define MSD_MEDIA_KEYS_MANAGER_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MSD_TYPE_MEDIA_KEYS_MANAGER, \
                           MsdMediaKeysManagerClass))
#define MSD_IS_MEDIA_KEYS_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), MSD_TYPE_MEDIA_KEYS_MANAGER))
#define MSD_IS_MEDIA_KEYS_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), MSD_TYPE_MEDIA_KEYS_MANAGER))
#define MSD_MEDIA_KEYS_MANAGER_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MSD_TYPE_MEDIA_KEYS_MANAGER, \
                             MsdMediaKeysManagerClass))
...
struct _MsdMediaKeysManagerClass {
  ...
  void (*media_player_key_pressed)(MsdMediaKeysManager *manager,
                                   const char *application, const char *key);
};

...
#define MSD_A11Y_KEYBOARD_MANAGER(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MSD_TYPE_A11Y_KEYBOARD_MANAGER, \
                              MsdA11yKeyboardManager))
#define MSD_A11Y_KEYBOARD_MANAGER_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MSD_TYPE_A11Y_KEYBOARD_MANAGER, \
                           MsdA11yKeyboardManagerClass))
#define MSD_IS_A11Y_KEYBOARD_MANAGER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), MSD_TYPE_A11Y_KEYBOARD_MANAGER))
#define MSD_IS_A11Y_KEYBOARD_MANAGER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), MSD_TYPE_A11Y_KEYBOARD_MANAGER))
#define MSD_A11Y_KEYBOARD_MANAGER_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MSD_TYPE_A11Y_KEYBOARD_MANAGER, \
                             MsdA11yKeyboardManagerClass))

...
#define MSD_DATETIME_MECHANISM(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MSD_DATETIME_TYPE_MECHANISM, \
                              MsdDatetimeMechanism))
#define MSD_DATETIME_MECHANISM_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MSD_DATETIME_TYPE_MECHANISM, \
                           MsdDatetimeMechanismClass))
#define MSD_DATETIME_IS_MECHANISM(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), MSD_DATETIME_TYPE_MECHANISM))
#define MSD_DATETIME_IS_MECHANISM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), MSD_DATETIME_TYPE_MECHANISM))
#define MSD_DATETIME_MECHANISM_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MSD_DATETIME_TYPE_MECHANISM, \
                             MsdDatetimeMechanismClass))
...
#define MSD_DATETIME_MECHANISM_TYPE_ERROR \
  (msd_datetime_mechanism_error_get_type())
